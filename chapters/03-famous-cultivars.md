...
![Famous Cultivars Comparison]({{ '/assets/images/famous-cultivars.png' | relative_url }})
...
### ['Ukigumo']({{ '/cultivars/ukigumo' | relative_url }}) (The Floating Cloud)
...
| :--- | :--- | :--- | :--- | :--- |
| **['Bloodgood']({{ '/cultivars/bloodgood' | relative_url }})** | Consistent Red | High | Fast | Anchor Specimen |
| **['Osakazuki']({{ '/cultivars/osakazuki' | relative_url }})** | Best Fall Red | Medium | Moderate | Focal Point |
| **['Seiryu']({{ '/cultivars/seiryu' | relative_url }})** | Upright Laceleaf | High | Fast | Narrow Spaces |
| **['Mikawa']({{ '/cultivars/mikawa-yatsubusa' | relative_url }})** | Shingled Layers | Medium-High | Slow | Containers / Rocks |
| **['Tamukeyama']({{ '/cultivars/tamukeyama' | relative_url }})** | Weeping Red | High | Moderate | Ponds / Slopes |
| **['Ukigumo']({{ '/cultivars/ukigumo' | relative_url }})** | White Foliage | Very Low | Slow | Shaded Courtyard |
| **['Katsura']({{ '/cultivars/katsura' | relative_url }})** | Orange Spring | Medium | Moderate | Early Interest |
| **['Jordan']({{ '/cultivars/jordan' | relative_url }})** | Neon Yellow | Low-Medium | Slow | Shaded Contrast |
| **['Shishigashira']({{ '/cultivars/shishigashira' | relative_url }})**| Crinkled Mane | High | Slow | Sculptural |
