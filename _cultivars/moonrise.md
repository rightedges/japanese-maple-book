...
## Garden Use & Care
'Moonrise' is a versatile centerpiece. It works beautifully as a specimen plant, providing a warm, illuminated focal point in morning sun settings. It is also an excellent choice for a large container or as a component of a tall mixed border. Its luminous chartreuse-and-red foliage pairs exceptionally well with purple-leaved cultivars like 'Bloodgood'.

### Maintenance Tips
- **The Sun/Color Balance**: While more sun-tolerant than 'Aureum', it performs best in morning sun with afternoon shade. This balance preserves the best "red-flush" on the chartreuse leaves without risking leaf scorch.
...
- **Vigor**: More robust than many of its kin; benefits from a steady moisture regime and an annual application of balanced organic fertilizer in early spring.

> [!TIP]
> Think of 'Moonrise' as an "improved Aureum." It provides that legendary golden-full-moon look but with much greater resilience and a spectacular red spring flush that 'Aureum' lacks.
